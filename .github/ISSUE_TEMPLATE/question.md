...
> _Before posting a new question, please read the [documentation](https://github.com/lequal/sonar-frama-c-plugin/wiki) and check [existing issues](https://github.com/lequal/sonar-frama-c-plugin/issues)._
